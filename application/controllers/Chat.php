...
class Chat extends General_Accaunt {
    ...
    public function index()
  	{
        ...
        $this->load->view('chat_messages_view',$data);
    }
  ...
  public function show($user_id = '')
	{
      ...
      if(empty($user_id) || ($user_id == $this->session->user_id)){
      ...
      $data['chat'] = $this->chat_model->get_chat_users();
