...
class Forecast_handball_model extends CI_Model {


  /**
   * ხელბურთის მატჩის პროგნოზების გაკეთება
   *
   * @param
   * @return
   */
   public function to_forecast_handball(){
     ...
     */
     ...
     // $matches_post_data = '10559533=X=132|10559534=2';
           ...
           switch ($match[1]) {
             ...
             // მოწმდება რომ კოეფიციენტი არ იყოს 1.4 ზე დაბალი
               ...
               // შევიტანოთ ბაზაში მომხმარებლის პროგნოზი
                ...
                VALUES($user_id,1002,'".$result[0]['xml_id']."','".$result[0]['match_name']."',
                '".$oddType."','".abs((int) $match[2])."','".$result[0][$oddType]."','".$result[0]['start_date']."')";
