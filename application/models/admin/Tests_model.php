       ...
       for ($j=0; $j < $counter; $j++) {
           ...
           for ($i=0; $i < $limit_value; $i++) {
            ...
            // $rand_sport_id = $arrayName[array_rand($arrayName)];
             ...
             '".$oddType."','".$football_matches[$i][$oddType]."','".$football_matches[$i]['start_date']."')";
             $this->db->query($sql2);
           }
         }
      }
             ...
             if(count($football_matches) < $limit_value){
               ...
               for ($i=0; $i < $limit_value; $i++) {
                ...
                // $rand_sport_id = $arrayName[array_rand($arrayName)];
                 ...
                 '".$oddType."','".$football_matches[$i]['under_over_val']."','".$football_matches[$i][$oddType]."','".$football_matches[$i]['start_date']."')";
                 $this->db->query($sql2);
               }
             }
          }
