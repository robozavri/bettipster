...
class Basketball_result_model extends CI_Model {


  /**
   * პარსავს კალათბურთის xml-ს და ბაზაში განაახლებს შედეგებს და
   * შეამოწმებს მომხმარებლის პროგნოზი გამართლდა თუ არა
   *
   * @param
   * @return array
   */
   public function check_basketball_matches_result(){

     $url = "http://ad.interwetten.com/XMLFeeder/feeder.asmx/getfeed?FEEDPARAMS=EventResults|LANGUAGE=EN|KINDOFSPORTIDS=15";
    // $url = "baketresult.xml";
    try {
...
public function check_match_result($match_id = '',$match_result = ''){
    ...
    /*ზოგიერთი გადადებული მატჩის შედეგი ცარიელი მოდის*/
      ...
      $sql = "UPDATE forecasted_matches
              ...
              WHERE sport_id = 15 AND xml_id = ".(int) $match_id." AND status = 0
              ";
