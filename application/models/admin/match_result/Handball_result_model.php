...
class Handball_result_model extends CI_Model {


  /**
   * პარსავს ხელბურთი xml-ს და ბაზაში განაახლებს შედეგებს და
   * შეამოწმებს მომხმარებლის პროგნოზი გამართლდა თუ არა
   *
   * @param
   * @return array
   */
   public function check_handball_matches_result(){

     $url = "http://ad.interwetten.com/XMLFeeder/feeder.asmx/getfeed?FEEDPARAMS=EventResults|LANGUAGE=EN|KINDOFSPORTIDS=1002";
    //  $url = "bsktbMatchResutls.xml";
...
public function check_match_result($match_id = '',$match_result = ''){
    ...
    /*ზოგიერთი გადადებული მატჩის შედეგი ცარიელი მოდის*/
      ...
      $sql = "UPDATE forecasted_matches
              ...
              WHERE sport_id = 1002 AND xml_id = ".(int) $match_id." AND status = 0
              ";
