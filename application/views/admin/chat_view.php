    	...
    	<div class="col-md-8">
            ...
            <div class="chat-box bg-white">
              <form id="chat_form" class="" action="<?php echo base_url('panel/Ajax_Chat/send');?>" method="post">
                <div id="user_data" data-userid="<?php echo $this->session->admin_user_id;?>" data-avatar="<?php echo base_url('uploads/avatars').'/'.$this->session->avatar;?>" data-username="<?php echo $this->session->username;?>"></div>
