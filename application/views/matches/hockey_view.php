...
<?php endif; ?>
	...
	function sendMatch(){
			...
			if(arr[0] != undefined){
				...
				$.ajax({
				    type: "POST",
				    url: "<?php echo base_url();?>Ajax_forecast/to_forecast/6",
...
<div class="col-md-7 col-sm-12">
 <h1 class="sport-titles-widtout-bg"><? if(!empty($league_name)) { print $league_name[0]['league_name'];}?></h3>
			<table id="matches" class="table table-bordered to-forecast-table">
				<tr class="bgnone">
					...
					<th>X</th>
					<th>2</th>
					<th><?php //under echo $this->lang->line('text_Under');?> < 5.5</th>
					<th><?php //over echo $this->lang->line('text_Over');?> > 5.5</th>
...
if (typeof(Storage) !== "undefined") {
  ...
  $(".matchData").click(function(e){
		...
		if($(e.target).attr('data-add-type')){
		 ...
		 switch(odd){
			 	case 'under' : showOdd = '< 5.5';
			 	break;
			 	case 'over' : showOdd = '> 5.5';
			 	break;
			 	default : showOdd = odd;
			 }
