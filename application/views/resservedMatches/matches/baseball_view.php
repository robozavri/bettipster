...
<?php endif; ?>
	...
	function sendMatch(){
			...
			if(arr[0] != undefined){
				...
				$.ajax({
				    type: "POST",
				    url: "<?php echo base_url();?>Ajax_forecast/to_forecast/2",
				...
				$now = time();
				 ...
				 ?>
					<tr data-id="<?php echo $match['xml_id'];?>" class="matchData">
						...
						<td><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span><?php echo $match['under_over_val'].'.5';?> <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></td>
